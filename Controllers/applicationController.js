...
exports.getApplication = async (req, res) => {
  const getAppQuery =
    "Select a.*, c.category_name,d.url FROM category c  RIGHT JOIN application a  ON a.category_id=c.id LEFT JOIN dashboard d ON d.app_id=a.id WHERE a.is_deleted=FALSE ORDER BY display_order,title";
  try {
